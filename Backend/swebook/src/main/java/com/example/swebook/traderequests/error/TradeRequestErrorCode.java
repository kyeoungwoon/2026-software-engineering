...
public enum TradeRequestErrorCode implements ErrorCode {
    ...
    TRADE_POST_NOT_AVAILABLE(HttpStatus.CONFLICT, "TRADE_REQUEST_409_002", "해당 판매글은 현재 거래 요청을 수락할 수 없는 상태입니다."),
    TRADE_REQUEST_ALREADY_PROCESSED(HttpStatus.CONFLICT, "TRADE_REQUEST_409_003", "이미 처리된 거래 요청입니다.");
